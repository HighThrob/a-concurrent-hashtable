...
{
    using DTA = DictionaryTestAdapter<Tuple<object, int>, object, WeakDictionary<object, int, object>>;
    
    [TestClass]
    public class WeakDictionary1Test
    {
        class WeakDictionary1Adaper : IDictionaryTestAdapter<Tuple<object,int>,object,WeakDictionary<object,int,object>>
        {
            #region IDictionaryTestAdapter<Tuple<object,int>,object,WeakDictionary<object,int,object>> Members
            ...
            public WeakDictionary<object, int, object> GetDictionary()
            { return new WeakDictionary<object, int, object>(); }

            public bool ContainsKey(WeakDictionary<object, int, object> d, Tuple<object, int> k)
            ...
            public object GetItem(WeakDictionary<object, int, object> d, Tuple<object, int> k)
            { return d[ k.Item1, k.Item2 ]; }

            public void SetItem(WeakDictionary<object, int, object> d, Tuple<object, int> k, object v)
            { d[k.Item1, k.Item2] = v; }

            public bool IsEmpty(WeakDictionary<object, int, object> d)
            { return d.IsEmpty; }

            public object AddOrUpdate(WeakDictionary<object, int, object> d, Tuple<object, int> k, Func<Tuple<object, int>, object> addValueFactory, Func<Tuple<object, int>, object, object> updateValueFactory)
            {
                return 
                    d.AddOrUpdate(
                        k.Item1, 
            ...
            public KeyValuePair<Tuple<object, int>, object>[] ToArray(WeakDictionary<object, int, object> d)
            { return d.ToArray(); }

            public bool TryAdd(WeakDictionary<object, int, object> d, Tuple<object, int> k, object v)
            { return d.TryAdd(k.Item1, k.Item2, v ); }

            public bool TryRemove(WeakDictionary<object, int, object> d, Tuple<object, int> k, out object v)
        ...
        DTA DTA = new DTA { _adapter = new WeakDictionary1Adaper() } ;
