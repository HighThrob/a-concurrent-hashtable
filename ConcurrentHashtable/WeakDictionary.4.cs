...
namespace TvdP.Collections
{
    ...
    [Serializable]
#endif
    public class WeakDictionary<TWeakKey1, TWeakKey2, TWeakKey3, TWeakKey4, TStrongKey, TValue> : DictionaryBase<Tuple<TWeakKey1, TWeakKey2, TWeakKey3, TWeakKey4, TStrongKey>, TValue>
#if !SILVERLIGHT
    , ISerializable
#endif
        ...
        where TValue : class
    {
        ...
        public WeakDictionary(IEqualityComparer<TWeakKey1> weakKey1Comparer, IEqualityComparer<TWeakKey2> weakKey2Comparer, IEqualityComparer<TWeakKey3> weakKey3Comparer, IEqualityComparer<TWeakKey4> weakKey4Comparer, IEqualityComparer<TStrongKey> strongKeyComparer)
        ...
        public WeakDictionary(IEnumerable<KeyValuePair<Tuple<TWeakKey1, TWeakKey2, TWeakKey3, TWeakKey4, TStrongKey>, TValue>> collection)
        ...
        public WeakDictionary(int concurrencyLevel, int capacity, IEqualityComparer<TWeakKey1> weakKey1Comparer, IEqualityComparer<TWeakKey2> weakKey2Comparer, IEqualityComparer<TWeakKey3> weakKey3Comparer, IEqualityComparer<TWeakKey4> weakKey4Comparer, IEqualityComparer<TStrongKey> strongKeyComparer)
        {
            _internalDictionary =
                new InternalWeakDictionary(
                    concurrencyLevel,
